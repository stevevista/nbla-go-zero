...
void go_window::scale_res() {
    ...
    long wood_size = radius*2 * 19 + edge_size*2;
...
void go_window::on_window_resized() {
    ...
    auto new_radius = (length - edge_size*2) / (19*2);
...
void go_window::update(int move, int _board[]) {
