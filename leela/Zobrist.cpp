...
std::array<std::array<std::uint64_t, FastBoard::BOARDSQ>,     4> Zobrist::zobrist;
std::array<std::uint64_t, FastBoard::BOARDSQ>                    Zobrist::zobrist_ko;
std::array<std::array<std::uint64_t, FastBoard::BOARDSQ * 2>, 2> Zobrist::zobrist_pris;
...
void Zobrist::init_zobrist(Random& rng) {
    ...
    for (int i = 0; i < 2; i++) {
        for (int j = 0; j < FastBoard::BOARDSQ * 2; j++) {
