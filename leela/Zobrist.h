...
public:
    ...
    static std::array<std::array<std::uint64_t, FastBoard::BOARDSQ>,     4> zobrist;
    static std::array<std::uint64_t, FastBoard::BOARDSQ>                    zobrist_ko;
    static std::array<std::array<std::uint64_t, FastBoard::BOARDSQ * 2>, 2> zobrist_pris;
